        ...
        <div className={styles.card}>
            ...
            <div className={styles.totalProgress}>
                <div className={styles.progressContainer}>
                    <CircularProgressbar value={overdueTasks.length} maxValue={todos.length} text={`${overdueTasks.length}/${todos.length}`}
                        styles={buildStyles({
                            textColor: "#101B28",
                            pathColor: "#DC6803",
                            trailColor: "#FEF0C7"
                ...
                <div className={styles.progressContainer}>
                    <CircularProgressbar value={finishedTasks.length} maxValue={todos.length} text={`${finishedTasks.length}/${todos.length}`}
                        styles={buildStyles({
                            textColor: "#101B28",
                            pathColor: "#56B87D",
                            trailColor: "#E5F2EA"
